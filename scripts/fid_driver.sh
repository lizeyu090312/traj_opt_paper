...
COMMON_EXPORTS="FID_ONLY=0,BATCH_SIZE=200,NUM_SAMPLING_NFE=250,SAMPLING_METHOD=heun2,NUM_FID_SAMPLES=50000,IMAGE_SIZE=256,MODE=ODE,REF_PATH=$REF_PATH,RESULT_ROOT=$RESULT_ROOT,IMAGE_ROOT=$IMAGE_ROOT"
