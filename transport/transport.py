...
class Transport:
    ...
    def training_losses(
        ...
        - plan_fn: optional callable override returning (t, xt, ut)
        """
        ...
        if plan_fn is None:
            ...
            if self.model_type != ModelType.VELOCITY:
                raise NotImplementedError("Custom training plans are only supported for velocity prediction.")
            t, xt, ut = plan_fn(t=t, x0=x0, x1=x1, model_kwargs=model_kwargs)
